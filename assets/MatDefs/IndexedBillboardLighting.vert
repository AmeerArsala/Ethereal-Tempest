...
void main(){
   ...
   //vec3 viewDir = normalize(-wvPosition);
    ...
    // *** Determine the positions and normals
        ...
        // Calculate the texture cell based on direction... but
        // we need the ground direction and so we may have to back
        // down the normal
        //vec3 groundPos = wPosition.xyz - wNormal * modelSpacePos.y;

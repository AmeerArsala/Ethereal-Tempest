 ...
 * @author night
 */
public class SimpleProcedureGroup {
    protected final List<SimpleProcedure> procedures = new LinkedList<>();
    protected final ArrayList<SimpleProcedure> finished = new ArrayList<>();
    
    public SimpleProcedureGroup() {}

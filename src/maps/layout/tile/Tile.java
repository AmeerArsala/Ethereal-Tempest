...
public class Tile {
    ...
    public Tile(int posx, int posy, int elevation) {
    ...
    public Vector3f getWorldTranslation() { return tgeometry.getWorldTranslation(); }
    public Vector3f getLocalTranslation() { return tgeometry.getLocalTranslation(); }

...
public class RadialProgressBar extends Node {
    ...
    public RadialProgressBar(float innerRadius, float outerRadius, ColorRGBA color, int specificity, AssetManager assetManager) { 
        ...
        progress = new Material(assetManager, MaterialCreator.UNSHADED);

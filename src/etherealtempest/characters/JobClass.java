...
import battle.animation.AttackConfig;
...
public class JobClass extends Entity {
    ...
    public JobClass(String jobname, List<String> mobilityTypes, List<String> wieldableWeaponTypes, List<StatBundle> bonusStats, List<StatBundle> battleBonus, List<StatBundle> maxStats, String desc, int tier) {
        this(jobname, jobname, mobilityTypes, wieldableWeaponTypes, bonusStats, battleBonus, maxStats, desc, tier);
    }
    
    public JobClass(String jobname, List<String> mobilityTypes, List<String> wieldableWeaponTypes, HashMap<BaseStat, Integer> bonusStats, HashMap<BattleStat, Integer> battleBonus, HashMap<BaseStat, Integer> maxStats, String desc, int tier) {
        this(jobname, jobname, mobilityTypes, wieldableWeaponTypes, bonusStats, battleBonus, maxStats, desc, tier);
    }
    
    protected JobClass(String jobname, String real, List<String> mobilityTypes, List<String> wieldableWeaponTypes, List<StatBundle> bonusStats, List<StatBundle> battleBonus, List<StatBundle> maxStats, String desc, int tier) {
        super(real);
    ...
    protected JobClass(String jobname, String real, List<String> mobilityTypes, List<String> wieldableWeaponTypes, HashMap<BaseStat, Integer> bonusStats, HashMap<BattleStat, Integer> battleBonus, HashMap<BaseStat, Integer> maxStats, String desc, int tier) {
        super(real);
        this.jobname = jobname;
        this.mobilityTypes = mobilityTypes;
        this.wieldableWeaponTypes = wieldableWeaponTypes;
    ...
    public String getClassDescription() { return classDesc; }
